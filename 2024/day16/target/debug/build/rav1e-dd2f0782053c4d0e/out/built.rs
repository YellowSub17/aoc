...
#[allow(dead_code)]
pub static RUSTC: &str = "/Users/pat/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "/Users/pat/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc";
...
#[doc=r#"The output of `/Users/pat/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustc -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.88.0 (6b00bc388 2025-06-23)";
#[doc=r#"The output of `/Users/pat/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc -V`; empty string if `/Users/pat/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
